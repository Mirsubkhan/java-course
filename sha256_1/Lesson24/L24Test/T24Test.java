...
class T24Test {
    ...
    public void testAdd() {
        ...
        fr1.add(fr2);
        assertEquals("6/4", fr1.toString(), "2/4 + 4/4 should give 6/4");
    }
    ...
    public void testSubtract() {
        ...
        fr1.subtract(fr2);
        assertEquals("2/4", fr1.toString(), "5/4 - 3/4 should give 2/4");
    }
    ...
    public void testDivide() {
        ...
        Fraction fr2 = new Fraction(4, 5);
        fr1.divide(fr2);
        assertEquals("10/12", fr1.toString(), "2/3 ÷ 4/5 should give 10/12 (simplified to 5/6)");
    }
    ...
    public void testFractionDivisionByItself() {
        ...
        fr1.divide(fr1);
        assertEquals("1/1", fr1.toString(), "4/5 ÷ 4/5 should give 1/1");
    }
}
